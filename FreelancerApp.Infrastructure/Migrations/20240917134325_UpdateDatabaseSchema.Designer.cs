...
namespace FreelancerApp.Infrastructure.Migrations
{
    ...
    [Migration("20240917134325_UpdateDatabaseSchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FreelancerApp.Domain.Models.Client", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FreelancerApp.Domain.Models.Freelancer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FreelancerApp.Domain.Models.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            amount = 300m,
                            date = new DateTime(2024, 9, 17, 16, 43, 24, 819, DateTimeKind.Local).AddTicks(7275),
                            freelancerId = new Guid("21817b57-34dd-436c-a9ee-225dfe69a964"),
                            projectId = new Guid("c411dae6-2ca6-4ea7-9f1a-b366f9f518d5")
                        });
                });

            modelBuilder.Entity("FreelancerApp.Domain.Models.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FreelancerApp.Domain.Models.Payment", b =>
                {
                    b.HasOne("FreelancerApp.Domain.Models.Freelancer", "freelancer")
                        .WithMany()
                        .HasForeignKey("freelancerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FreelancerApp.Domain.Models.Project", "project")
                        .WithMany()
            ...
            modelBuilder.Entity("FreelancerApp.Domain.Models.Project", b =>
                {
                    b.HasOne("FreelancerApp.Domain.Models.Client", "client")
                        .WithMany("Projects")
